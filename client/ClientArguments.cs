...
/// (<c>src/SRDCombat.Console/ConsoleArguments.cs</c>'s <c>TryParseLevel</c> and its
/// siblings) is a different binary's convention and is deliberately not accepted. <c>null</c>
