...
SRD_Combat is pre-1.0 and does not yet publish supported release branches. Security
fixes are made on the current `main` branch; old commits, development branches, and
locally built snapshots do not receive backports.
...
<https://github.com/brandonifco/SRD_Combat/security/advisories/new>
