# CLAUDE.md as of 2026-08-21 — archived verbatim

This is the full operational file as it stood at PR #282, preserved when the
finishing plan replaced it. Nothing here was deleted from history — the narrative
reasoning behind every measured slice, the pacing tables, the squad-AI series, the
client/art evolution and the closed rules backlog all live in this file. The
rewritten CLAUDE.md keeps the load-bearing rules and links here for the depth.
...
**As of 2026-08-21.** All numbers here are verified, not estimated.

| | |
| --- | --- |
| Branch | `main` after the 2026-08-21 batch — eight slices, most asked for from play: the grid wears a **fog of war** (#274, `PartyVision` in `Game` — a display judgement, never a rule), the **battlefield grew to 28 × 18** with every new square flanking room (#277), each ranged attack **flies its own projectile art** with three of Brandon's drawings (#276, #280), a right-button drag pans the camera (#275), input waits for the animation it would interrupt (#273), the ground beyond the field is no longer darkened (#272), and **a fight with no able enemy left finishes what is standing** (#279) — the two-Basilisk stall the 28 × 18 measurement itself surfaced. (The 2026-08-16 play session's four slices — MIT licence #202, printed pass-through movement #203, classic-monster weight #204, opening-cycle Long Rests #205 — are folded into the sections below) |
...
| Pacing | **The ladder has a difficulty curve for the first time, and warband rungs (#207) are what gave it one.** Current `main`, measured 2026-08-21, `tools/PacingMeasure`, loot on: seeds 1–120 read **median 18, 27 of 120 clearing everything, 57 reaching level 4, 10 dying by fight 4**; seeds 200–320 read **18, 31, 50, and 14**. (The 2026-08-16 build read 38/56/3 and 43/60/9 — the ground between is the printed starting weapons, the long-range throw discount, battle layouts, the 28 × 18 board and the petrified-fight completion fix, each measured on its own bullet below.) **The median measures again** — it had been pinned at 30 of 30 for several slices, where a saturated statistic reads identically whether a change helped, hurt or did nothing. Read the `shape:` and per-band lines with it: `died-by-fight-4` for the opening, `cleared-all` for the ending, hp-left per band for whether a fight was ever close. **The per-band line is the one that changed**: party hit points left used to be flat at 75–81% in *every* band from fights 1–5 to 26–30 — fight 27 was not harder than fight 3, only longer — and now runs **83% → 76% → 68% → 73% → 67% → 69%** (2026-08-21). The distribution moved with it: runs ending in the middle rather than at either extreme went **47 → 83** of 120, so the old die-early-or-clear-everything split is gone. Five slices on 2026-08-16, each against a same-build baseline taken immediately before: **movement's printed pass-through clauses** (#203) clears 72 → 76; **the classic-monster weight** (#204) clears 76 → 66, a *difficulty* gain from a flavour change, because a classic monster carries more mechanics per XP than an animal; **resting Long through the opening cycle** (#205) died-by-fight-4 15 → 1 and 14 → 6; and **warbands** (#207) clears 72 → 38 and 78 → 43. **A human played the warband ladder on 2026-08-16 and the verdict was "definitely tense.
...
dotnet test SRDCombat.sln -c Debug          # expect 972 passing, 1 skipped by design
